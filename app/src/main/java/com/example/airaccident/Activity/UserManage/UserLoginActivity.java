package com.example.airaccident.Activity.UserManage;
...
import static com.example.airaccident.AppConfigure.network.Url.userLogin;
...
public class UserLoginActivity extends AppCompatActivity {
    ...
    private void initData(){
        ...
        wangjimima.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(UserLoginActivity.this, UserPasswordActivity.class);
        ...
        zhuce.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2=new Intent(UserLoginActivity.this, UserRegistActivity.class);
