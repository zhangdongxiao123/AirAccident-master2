...
import com.example.airaccident.Search.sactivity.ReasonDetailActivity;
...
public class ReasonListAdapter extends  RecyclerView.Adapter<ReasonListAdapter.MyViewHolder> {
    ...
    public ReasonListAdapter(Context context, List<ReasonListBean.DataBean> list) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ReasonDetailActivity.class);
