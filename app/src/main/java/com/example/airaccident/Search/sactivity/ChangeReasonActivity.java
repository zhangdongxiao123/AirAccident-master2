...
import com.example.airaccident.Adapter.ReasonListAdapter;
...
import static com.example.airaccident.app.Url.newsreasonsingleSelect;
import static com.example.airaccident.app.Url.singleSelect;

public class ChangeReasonActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initView() {
        ...
        //初始化适配器
        list = new ArrayList<>();
        reasonListAdapter = new ReasonListAdapter(this,list);
        //设置RecyclerView为纵向布局
        liebiao.setLayoutManager(new LinearLayoutManager(this));
        //给列表设置适配器
        liebiao.setAdapter(reasonListAdapter);
        //2.设置点击事件
